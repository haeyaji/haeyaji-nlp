...
- 후보의 실제 정보(분류, 주소, 거리)를 이유(reason)에 활용해라.
  (예: "도보 5분 거리", "순대 전문점이라", "전시 공간이 넓어서")
...
_RAG_FEWSHOT_ASSISTANT = (
    ...
    '"todos":['
    '{"title":"농민백암순대 본점에서 순대국 점심","reason":"도보 6분 거리의 순대 전문점 — 든든한 한식 점심으로 제격",'
    '"category":"맛집/카페","estimated_minutes":60,"place_name":"농민백암순대 본점"},'
    '{"title":"청류벽에서 한식 정찬","reason":"333m로 더 가까운 한식당 — 여유 있게 식사하기 좋음",'
